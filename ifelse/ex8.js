...
let peso = parseFloat(prompt("Digite seu peso, em kilogramas:"))
let altura = parseFloat(prompt("Digite sua altura, em metros"))
let imc = peso / (altura * altura)

if (imc < 18.5) {
    alert("IMC de " + imc + ". Você está a baixo do peso!")
} else if (imc >= 18.5 && imc <= 24.9) {
    alert("IMC de " + imc + ". Seu Peso está normal!")
} else if (imc >= 25.0 && imc <= 29.9) {
    alert("IMC de " + imc + ". Você está com sobrepeso!")
} else if (imc >= 30.0 && imc <= 34.9) {
    alert("IMC de " + imc + ". Você está com Obesidade (Grau 1)!")
} else if (imc >= 35.0 && imc <= 39.9) {
    alert("IMC de " + imc + ". Você está com Obesidade (Grau 2)!")
} else if (imc >= 40.0) {
    alert("IMC de " + imc + ". Você está com Obesidade (Grau 3)!")
}